               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="ws-colors">'+
                        ...
                        '<a href="#color8" class="styleswitch" id="color8">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color9" class="styleswitch" id="color9">'+
                            '&nbsp;'+
                        '</a>'+                        
                        '<a href="#color10" class="styleswitch" id="color10">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color11" class="styleswitch" id="color11">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color12" class="styleswitch" id="color12">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color13" class="styleswitch" id="color13">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color14" class="styleswitch" id="color14">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color15" class="styleswitch" id="color15">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color16" class="styleswitch" id="color16">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color17" class="styleswitch" id="color17">'+
                            '&nbsp;'+
                        '</a>'+
                        '<a href="#color18" class="styleswitch" id="color18">'+
                            '&nbsp;'+
                        '</a>'+
